node{
    ...
    stage("deploy"){
        if (env.BRANCH_NAME == "develop")
            ...
            nexusArtifactUploader artifacts: [[artifactId: readMavenPom().getArtifactId(), classifier: '', file: 'target/crudApp.war', type: 'war']], credentialsId: 'NEXUS_CREDENTIALS', groupId: 'com.app', nexusUrl: '$nexus_url', nexusVersion: 'nexus3', protocol: 'http', repository: 'qa', version: '0.0.1-SNAPSHOT'
