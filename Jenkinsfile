node{
    ...
    stage("deploy"){
        if (env.BRANCH_NAME == "develop")
            ...
            nexusArtifactUploader artifacts: [[artifactId: readMavenPom().getArtifactId(), classifier: '', file: 'target/crudApp.war', type: readMavenPom().getPackage]], credentialsId: 'NEXUS_CREDENTIALS', groupId: 'com.app', nexusUrl: '$nexus_url', nexusVersion: 'nexus3', protocol: 'http', repository: 'qa', version: readMavenPom().getVersion()
